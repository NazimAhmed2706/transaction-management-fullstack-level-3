...
function TransactionHistory() {
    ...
    useEffect(() => {
        ...
        axios
            ...
            console.log("TransactionHistory.jsx= => TransactionHistory => GET http://localhost:5000/transactions : ", res.data);
            const arrayOfTransactions = JSON.parse(res.data);
            ...
            for (let index = 0; index < arrayOfTransactions.length; index++) {
                ...
                var indexingTransactionSummary = "Transferred " + txnAmt + "$ " + txnDir + " account " + transaction.account_id + ".";
                ...
                if(index === arrayOfTransactions.length - 1){
                    ...
                    axios
                        ...
                        .then((res) => {
                            ...
                            console.log("TransactionHistory.jsx= => TransactionHistory => GET http://localhost:5000/accounts/" + transaction.account_id + " : ", res.data);
                            const accountDetails = JSON.parse(res.data);
